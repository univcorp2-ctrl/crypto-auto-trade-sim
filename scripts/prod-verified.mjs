...
function tg(name, body, attrs) { return L + name + attrsToText(attrs || {}) + R + String(body || '') + L + S + name + R; }
function voidTag(name, attrs) { return L + name + attrsToText(attrs || {}) + R; }
